...
def TestFunc(Codeaddr,Codetype):
    ...
    #识别类型:10400 4位纯数字   ,20400 4位纯英文,   30400 4位数字英文, 40400 4位汉字    ,50200 复杂计算题，更多：http://www.fateadm.com/price.html
